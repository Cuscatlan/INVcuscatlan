...
function populateFormDetail($form, data,Entity) {
    ...
    $.each(data, function (key, value) {
        ...
        if ($ctrl.is('select')) {
            ...
            $("#" +Entity+ key).trigger("chosen:updated");
...
//  Presentacion de Mes segun numero de mes
//  Ricardo Martínez
...
//RMM proceso inverso
function desescribirMes(stringmes) {
    
    if (stringmes === "Enero") return 1;
    else if (stringmes === "Febrero") return 2;
    else if (stringmes === "Marzo") return 3;
    else if (stringmes === "Abril") return 4;
    else if (stringmes ===  "Mayo") return 5;
    else if (stringmes === "Junio") return 6;
    else if (stringmes === "Julio") return 7;
    else if (stringmes === "Agosto") return 8;
    else if (stringmes === "Septiembre") return 9;
    else if (stringmes === "Octubre") return 10;
    else if (stringmes === "Noviembre") return 11;
    else if (stringmes === "Diciembre") return 12;
    else return 0;
    
}

// Variable para cambiar el color de una línea en grid de matrices cuando estan incompletas de niveles
// Diana Campos 
var mtrIncomStyle = {'background-color': '#ffff99', 'color': 'black'};

// Mensaje de niveles faltantes para completar una matriz
// Diana Campos
function getMsjMtrFaltantes(countDet, nivelMatriz) {
    var nivelFal, countDetActual, detMtr;
    var msj = "";
    countDetActual = (parseInt(countDet) + 2);
    detMtr = (parseInt(nivelMatriz) * 2);
    if (countDetActual < detMtr) {
        var nivelFal = (detMtr - countDetActual) / 2;
        if (nivelFal > 0) {
            msj = "Hace falta agregar " + Math.ceil(nivelFal) + " nivel(es) al detalle de la Matriz";
        }
    }
    return msj;
}

//mramos función para validar rango de fechas 
function validate_fechaMayorQue(fechaInicial, fechaFinal)
{
    ...
    {
        swal("Error", "La vigencia final debe ser mayor a la vigencia inicial.", "error");
        return false;
    } else {
        return true;
    }
...
function accionBoton(idBoton, accion){
    $('#'+idBoton).attr('disabled', accion);
}